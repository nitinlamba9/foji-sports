      ...
      const initialProducts = [
        {
          ...
          material: 'Synthetic',
          tags: ['running', 'professional', 'athletic']
        },
        {
          id: '2',
          name: 'Sports Shorts',
          ...
          stock: 100,
          status: 'active',
          description: 'Comfortable sports shorts for workouts',
          ...
          material: 'Polyester',
          tags: ['shorts', 'comfortable', 'athletic']
        },
        {
          id: '3',
          ...
          images: ['https://images.unsplash.com/photo-1517465788289-56d7e2b1c1f6?w=300&h=300&fit=crop'],
          videos: [],
          sku: 'BAT-001',
          brand: 'MRF',
          sizes: [],
          colors: ['Brown'],
          weight: '1.2kg',
          dimensions: '85cm x 10cm x 5cm',
          material: 'Willow',
          tags: ['cricket', 'professional', 'sports']
        },
        {
          id: '4',
          ...
          images: ['https://images.unsplash.com/photo-1545205597-3d9d02c29597?w=300&h=300&fit=crop'],
          videos: [],
          sku: 'YOGA-001',
          brand: 'Reebok',
          sizes: [],
        ...
        },
        {
          ...
          rating: 4.1,
          reviews: 84,
          image: 'https://images.unsplash.com/photo-1577961081226-bd68e1b8addf?w=300&h=300&fit=crop',
          slug: 'training-t-shirt',
          category: 'apparel',
          stock: 75,
          status: 'active',
          description: 'Comfortable training t-shirt for workouts',
          images: ['https://images.unsplash.com/photo-1577961081226-bd68e1b8addf?w=300&h=300&fit=crop'],
          videos: [],
          sku: 'SHIRT-001',
          brand: 'Adidas',
          sizes: ['S', 'M', 'L', 'XL', 'XXL'],
          ...
          weight: '200g',
          dimensions: '70cm x 50cm x 2cm',
          material: 'Polyester',
          tags: ['training', 'comfortable', 'athletic']
        }
      ];
